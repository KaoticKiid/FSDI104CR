...
<p> Lives: ${this.lives}</p>`;
    ...
    attack = function (opponent) {
        ...
        if (opponent.energy <= 0) {
            document.getElementById(opponent.id).innerHTML = `<p> END OF DAYS FOR YOU. </P`;
...
const character1 = new Character("SSGSS Goku", 100, "c1", 1);
const character2 = new Character("Super Mario", 100, "c2", 1);
...
const item1 = new item("Dragonfist", 25, '<img class="imgItem" src="img/Dragonfist.png">');
const item2 = new item("Spiritbomb", 10, '<img class="imgItem" src="img/SpiritBomb.jpg">');
const item3 = new item("Kamehameha", 5,'<img class="imgItem" src="img/Kamehameha.webp">');
